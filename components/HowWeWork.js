        ...
        <div className="how-work-block flx100 v-center fc3">
          <div className="how-card flx25 pr">
            ...
            <div className="how-cards transit2 p24 bs2 mlr12 br4 bg4 ">
              ...
              <h3 className="how-card-title fw6 fs20 mb16">Fill The Form</h3>
          ...
          <div className="how-card flx25 pr mt48 pt48">
            ...
            <div className="how-cards transit2 p24 bs2 mlr12 br4 bg4 mt40">
              ...
              <p className="how-card-text lh24 mb24 fs15">
                Visiting hours 24/7. However, exceptions may apply in specific
                cases, so it's advisable to check with the hospital staff.
              </p>
            </div>
          </div>
          <div className="how-card flx25 pr">
            <div className="card-num-3 pa">
          ...
          <div className="how-card flx25 pr mt48 pt48">
            ...
            <div className="how-cards transit2 p24 bs2 mlr12 br4 bg4 mt40">
              ...
              <h3 className="how-card-title fw6 fs20 mb16">Access Reports</h3>
              <p className="how-card-text lh24 mb24 fs15">
                Access your medical records securely online. Register on our
                website or message us on WhatsApp for assistance with accessing
                your records.
              </p>
            </div>
          </div>
