...
const servicePageData = [
  {
    overview: {
      title: "Overview",
      subheading: "Comprehensive Care for Thyroid Health",
      content:
        "Welcome to Jeevan Raksha Hospital's Thyroid Disorders Services, where we specialize in the diagnosis and management of thyroid conditions. The thyroid gland plays a crucial role in regulating metabolism, energy levels, and other vital bodily functions. Thyroid disorders, such as hypothyroidism, hyperthyroidism, and thyroid nodules, can have significant effects on overall health and well-being. Our team of endocrinologists and thyroid specialists is dedicated to providing personalized care and support to patients with thyroid disorders. From accurate diagnosis to individualized treatment plans, we are committed to helping our patients achieve optimal thyroid health and improve their quality of life.",
      imageLink: "/images/pharmacy.jpg",
    },
    services: {
      title: "Services Offered",
      subheading: "Comprehensive Thyroid Care Solutions",
      content:
        "Jeevan Raksha Hospital offers comprehensive services for thyroid disorders, including diagnostic testing, hormone level monitoring, medication management, and thyroid surgery when necessary. Our experienced endocrinologists and thyroid specialists provide personalized treatment plans tailored to each patient's unique needs.",
      additionalServices: [
        {
    ...
    medicalTeam: {
      title: "Medical Team",
      subheading: "Expert Thyroid Care Team",
      content:
        "Our team of endocrinologists, thyroid surgeons, nurses, and support staff at Jeevan Raksha Hospital's Thyroid Disorders Services specializes in the diagnosis and management of thyroid conditions. With advanced training and expertise in thyroid care, our medical team ensures comprehensive and compassionate care for every patient.",
    },
    facilities: {
      title: "Facilities and Technology",
      subheading: "Advanced Thyroid Care Facilities",
      content:
        "Jeevan Raksha Hospital's Thyroid Disorders Services are conducted in modern facilities equipped with advanced technology for thyroid diagnosis and treatment. Our facilities include state-of-the-art imaging equipment, hormone testing laboratories, and dedicated thyroid surgery suites to ensure the highest standard of care for our patients.",
      facilitiesList: [
