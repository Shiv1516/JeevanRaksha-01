...
const servicePageData = [
  {
    overview: {
      title: "Overview",
      subheading: "Compassionate Support for Women's Health Choices",
      content:
        "Welcome to Jeevan Raksha Hospital's Medical Termination of Pregnancy (MTP) Services, where we provide compassionate and confidential care for women facing unplanned or medically indicated pregnancies. Our dedicated team of healthcare professionals understands the sensitive nature of this decision and is committed to providing nonjudgmental support, comprehensive counseling, and safe medical procedures. We prioritize the physical and emotional well-being of every patient and strive to ensure that they receive personalized care and support throughout their MTP journey.",
      imageLink: "/images/delivery.jpg",
    },
    services: {
      title: "Services Offered",
      subheading: "Holistic Reproductive Healthcare Solutions",
      content:
        "Jeevan Raksha Hospital offers comprehensive medical termination of pregnancy services, including counseling, medical assessments, and safe termination procedures. Our experienced gynecologists and support staff provide personalized care and support to ensure the comfort and well-being of every patient.",
      additionalServices: [
        {
          icon: "physiotherapy-02",
    ...
    medicalTeam: {
      ...
      content:
        "Our team of gynecologists, counselors, nurses, and support staff at Jeevan Raksha Hospital's MTP Services specializes in reproductive health care. With compassion and expertise, we provide nonjudgmental support and safe medical procedures to women seeking termination of pregnancy.",
    },
    facilities: {
      title: "Facilities and Technology",
      subheading: "Safe and Confidential Procedure Facilities",
      content:
        "Jeevan Raksha Hospital's MTP Services are conducted in safe and confidential facilities equipped with state-of-the-art medical technology. Our procedure rooms adhere to strict safety and privacy standards, ensuring that patients receive the highest quality of care in a supportive environment.",
      facilitiesList: [
...
export default function medicalTerminationOfPregnancy() {
