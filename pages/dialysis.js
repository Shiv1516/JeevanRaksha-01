...
const servicePageData = [
  {
    overview: {
      title: "Overview",
      subheading: "Empowering Renal Wellness with Dialysis Care",
      content:
        "Welcome to Jeevan Raksha Hospital's Dialysis Services, where we provide compassionate and comprehensive care for patients with kidney disease. Our state-of-the-art dialysis unit is equipped with advanced technology and staffed by experienced nephrologists and dialysis nurses, ensuring that patients receive high-quality treatment in a comfortable and supportive environment.",
      imageLink: "/images/dialysis.jpg",
    },
    services: {
      title: "Services Offered",
      subheading: "Comprehensive Dialysis Treatment Options",
      content:
        "At Jeevan Raksha Hospital, we offer a full range of dialysis services to meet the unique needs of each patient. Whether you require hemodialysis or peritoneal dialysis, our skilled team is dedicated to providing personalized treatment plans tailored to your medical condition and lifestyle. We also offer pre-dialysis education, vascular access management, and nutritional counseling to help you manage your kidney disease and improve your quality of life.",
      additionalServices: [
        {
    ...
    medicalTeam: {
      ...
      content:
        "Our team of nephrologists at Jeevan Raksha Hospital is committed to providing expert care and support for patients with kidney disease. With specialized training and experience in renal medicine, our physicians are skilled in diagnosing and treating a wide range of kidney-related conditions, including chronic kidney disease, end-stage renal disease, and electrolyte imbalances. Supported by dedicated dialysis nurses and support staff, our medical team works collaboratively to ensure that every patient receives personalized and compassionate care throughout their dialysis treatment.",
    },
    facilities: {
      title: "Facilities and Technology",
      subheading: "Advanced Dialysis Infrastructure",
      content:
        "Jeevan Raksha Hospital's dialysis unit is equipped with advanced technology and modern amenities to provide patients with a comfortable and efficient treatment experience. Our dialysis machines are state-of-the-art, featuring hemodiafiltration and online hemodiafiltration capabilities for optimal dialysis efficiency and patient safety. Additionally, our unit is designed to promote patient comfort and privacy, with spacious treatment bays, comfortable seating, and entertainment options to help patients relax during their dialysis sessions.",
      facilitiesList: [
