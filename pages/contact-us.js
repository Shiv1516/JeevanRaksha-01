          ...
          <div class="get-in-touch df mb48 ">
            <div class="get-in-touch-heading flx60">
              <div class="section-container mr48">
                <h2 class="section-heading fs36 lh58 fw ff2 mr48 pt8">
                Reach Out to Us
                </h2>
            ...
            <div class="form-section p32 box-sd2">
              <div class="form-heading">
                <h3 class="fs36 lh34 mtb24 fw5">Feel free to drop us a message</h3>
              </div>
              <div class="form mt32">
                    ...
                    <div class="input-column df fww flx50 mb16">
                      <label class="fw5 mb8 ml84 pl4" for="">Phone</label><br/>
                        ...
                        <div class="df fww flx100 pr8">
                          ...
                          <textarea class="flx100 pl12 pt8 mb8 db h80 br8 brd1 mlr4 "name="message" id="" rows="7" placeholder="Write a Message"></textarea>
                        </div>
