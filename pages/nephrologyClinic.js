...
const servicePageData = [
  {
    overview: {
      title: "Overview",
      subheading: "Specialized Care for Kidney Health",
      content:
        "Welcome to Jeevan Raksha Hospital's Nephrology Clinic, where we offer specialized care for patients with kidney diseases and disorders. The kidneys play a vital role in maintaining overall health by filtering waste products from the blood, regulating blood pressure, and balancing electrolytes. Our dedicated team of nephrologists and kidney specialists is committed to providing comprehensive care and support to patients with kidney conditions. From diagnosis and treatment to long-term management and education, we strive to optimize kidney health and improve the quality of life for our patients.",
      imageLink: "/images/physiotherapy.jpg",
    },
    services: {
      title: "Services Offered",
      subheading: "Comprehensive Kidney Care Solutions",
      content:
        "Jeevan Raksha Hospital's Nephrology Clinic offers a range of services for kidney health, including diagnostic testing, medication management, dietary counseling, and dialysis referral. Our experienced nephrologists provide personalized treatment plans to address each patient's unique kidney-related needs and concerns.",
      additionalServices: [
        {
    ...
    medicalTeam: {
      title: "Medical Team",
      subheading: "Expert Nephrology Care Team",
      content:
        "Our team of nephrologists, nurses, dietitians, and support staff at Jeevan Raksha Hospital's Nephrology Clinic specializes in providing expert care for kidney diseases and disorders. With advanced training and experience in nephrology, our medical team is dedicated to delivering compassionate and comprehensive kidney care to every patient.",
    },
    facilities: {
      title: "Facilities and Technology",
      subheading: "Advanced Kidney Care Facilities",
      content:
        "Jeevan Raksha Hospital's Nephrology Clinic is equipped with advanced facilities and technology for the diagnosis and treatment of kidney conditions. Our clinic features state-of-the-art diagnostic imaging equipment, laboratory facilities, and dedicated spaces for patient consultations and procedures, ensuring the highest quality of care for our patients.",
      facilitiesList: [
